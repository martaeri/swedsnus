(() => {
  ...
  function createMenu() {
    ...
    if (!drawer) {
      ...
      drawer.innerHTML = `<header class="hamburger-header"><a href="index.html" class="hamburger-logo" aria-label="Swedsnus startsida">Swedsnus<span>Tillverkare · Hemsjö, Sverige</span></a><button class="hamburger-close" type="button" aria-label="Stäng meny">×</button></header><nav class="hamburger-nav" aria-label="Mobil meny"><div class="hamburger-main-links">${menuLink('index.html', 'Hem', 'hamburger-link-main')}<span class="hamburger-link hamburger-link-main hamburger-link-static">Sortiment</span><div class="hamburger-submenu" aria-label="Subsortiment">${menuLink('portion.html', 'Portionssnus', 'hamburger-link-sub')}${menuLink('los.html', 'Lössnus', 'hamburger-link-sub')}${menuLink('vitt-snus.html', 'Vitt snus', 'hamburger-link-sub')}${menuLink('gor-eget.html', 'Gör eget', 'hamburger-link-sub')}${menuLink('tillbehor.html', 'Tillbehör', 'hamburger-link-sub')}</div>${menuLink('about.html', 'Om oss', 'hamburger-link-main')}${menuLink('guide.html', 'Guide', 'hamburger-link-main')}</div><div class="hamburger-secondary-links">${menuLink('account.html', 'Mina sidor', 'hamburger-link-secondary')}${menuLink('contact.html', 'Kundservice', 'hamburger-link-secondary')}</div></nav>`;

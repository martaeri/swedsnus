(() => {
  ...
  function addGuideResources() {
    ...
    section.innerHTML = `
      ...
      <p>Beredningsguiden beskriver de praktiska stegen för Instant Lössnus, Express Lössnus, Instant Portion och Super Dry. I de kompletterande sidorna finns mer information om produktkategorier, innehåll, förvaring och åldersgräns.</p>
      <div class="guide-resource-grid">
        ...
        <article class="guide-resource-card"><h3>Portionssnus</h3><p>Läs om white portion, portionsformat och produkter som färdigställs med vatten.</p><a href="portion.html">Läs om portionssnus →</a></article>

...
- `catalog.js`: public catalog entry point, sorting and mobile modal safeguards.
- `catalog-filters.js`: internal catalog filtering and drawer implementation.
